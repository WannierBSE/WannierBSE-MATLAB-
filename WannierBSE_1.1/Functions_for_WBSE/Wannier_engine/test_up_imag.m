...
%
% DESCRIPTION:
%   Regression helper for parsing and exporting the spin-up imaginary XSF component.
%==========================================================================

xsf_upimag_path = fullfile(Paths.xsf_root, 'up_imag');
output_target_dir = fullfile(Paths.temp_output, 'up_imag');

% --- Verify Input Data ---
% Validate the existence of the source component folder
if ~isfolder(xsf_upimag_path)
...
filePattern1 = fullfile(xsf_upimag_path, '*.xsf');
...
for k = 1:LEN
    ...
    fullFilePath = fullfile(xsf_upimag_path, filename);
