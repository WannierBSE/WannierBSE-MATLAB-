...
%
% DESCRIPTION:
%   Regression helper for parsing and exporting the spin-down imaginary XSF component.
%==========================================================================

xsf_downimag_path = fullfile(Paths.xsf_root, 'down_imag');
output_target_dir = fullfile(Paths.temp_output, 'down_imag');

% --- Verify Input Data ---
% Check for the existence of the specific component folder
if ~isfolder(xsf_downimag_path)
...
filePattern1 = fullfile(xsf_downimag_path, '*.xsf');
...
for k = 1:LEN
    ...
    fullFilePath = fullfile(xsf_downimag_path, filename);
