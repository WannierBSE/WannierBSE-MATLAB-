function [Vkkp, delta_kV] = coulomb_integral_d3h_dense(Nt, a, d, q_data, epsQ2D_data, frac_dense)
%==========================================================================
% COULOMB_INTEGRAL_D3H_DENSE
%
% DESCRIPTION:
%   Integrates the z-averaged screened Coulomb kernel over one dense D3h k-cell used near valley regions.
%
% INPUT ARGUMENTS:
%   Nt : dense mesh sampling parameter.
%   a : lattice constant in Angstrom.
%   d : effective material thickness.
%   q_data, epsQ2D_data : tabulated dielectric screening model.
%   frac_dense : dense-cell scale factor relative to the coarse cell.
%
% OUTPUT:
%   Vkkp : cell-averaged screened Coulomb integral.
%   delta_kV : associated dense k-space integration area.
%==========================================================================
...
% --- Geometric Grid Definitions (Scaled by frac_dense) ---
v1 = (pi/a).*[2/3, 2/sqrt(3)] ./ frac_dense;
v1_unit = v1./Nt;
