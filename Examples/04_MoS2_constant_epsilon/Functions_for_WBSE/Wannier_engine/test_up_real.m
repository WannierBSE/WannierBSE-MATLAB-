...
%
% DESCRIPTION:
%   Regression helper for parsing and exporting the spin-up real XSF component.
%==========================================================================

xsf_upreal_path = fullfile(Paths.xsf_root, 'up_real');
output_target_dir = fullfile(Paths.temp_output, 'up_real');

% --- Verify Input Data ---
% Validate the existence of the source component folder
if ~isfolder(xsf_upreal_path)
...
filePattern1 = fullfile(xsf_upreal_path, '*.xsf');
...
for k = 1:LEN
    ...
    fullFilePath = fullfile(xsf_upreal_path, filename);
